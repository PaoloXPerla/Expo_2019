...
const apiCategorias = '../../core/api/private/categorias.php?action=';
        ...
        content += `
            <tr>
                ...
                <td>
                    ...
                    <a href="#" onclick="confirmDelete(${row.Id_categoria}, '${row.imagen}')" class="red-text tooltipped" data-tooltip="Eliminar"><i class="material-icons">delete</i></a>
                </td>
            </tr>
        `;
    });
    ...
    .done(function(response){
        ...
        if (isJSONString(response)) {
            ...
            if (result.status) {
                ...
                $('#imagen_categoria').val(result.dataset.imagen);
                $('#update_nombre').val(result.dataset.Categoria);
                M.updateTextFields();
